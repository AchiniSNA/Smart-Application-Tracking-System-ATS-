...
def sanitize_text(text):
    """S
    Remove control characters and unnecessary whitespaces from text.
    """
        ...
        try:
            with st.spinner("📊 Analyzing your resume..."):
                ...
                resume_text = extract_pdf_text(uploaded_file)
                 ...
                 # Debugging: Log the resume and job description
                st.write("Debug - Resume Text:", resume_text)
                st.write("Debug - Job Description:", jd)
            
                # Prepare prompt
                resume_text = sanitize_text(resume_text)
                job_description = sanitize_text(jd)
